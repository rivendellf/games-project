...
describe("GET /api/reviews", () => {
  ...
  test("GET - 400 returns bad request error when invalid category", () => {
    return request(app)
      .get("/api/reviews?category=banana")
      .expect(400)
      .then((res) => {
        expect(res.body.msg).toBe("no such category!");
      });
  });
...
describe("GET /api/reviews/:review_id", () => {
  test("GET - 200: responds with an object of review information, adding a comment count property", () => {
    return request(app)
      .get("/api/reviews/2")
      .expect(200)
      .then((res) => {
...
describe("POST /api/reviews/:review_id/comments", () => {
  ...
  test("POST - 400: missing username or body returns bad request", () => {
    return request(app)
      ...
      .expect(400)
      .then((res) => {
        expect(res.body.msg).toBe("missing value!");
      });
  });
